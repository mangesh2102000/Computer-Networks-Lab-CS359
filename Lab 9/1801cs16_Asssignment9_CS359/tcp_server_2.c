...
void transfer(int sockfd) {
    while (1) {
        ...
        // check if received string is a palindrome or not
        ...
        if(is_palindrome){
            printf("Received string is a palindrome\n");
        }else{
            printf("Received string is not a palindrome\n");        
        }            
